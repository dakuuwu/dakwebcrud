...
<template>
  <div
    class="bg-slate-200 fixed inset-0 flex flex-col w-screen items-center justify-center"
  >
      <div
        v-show="loginError"
    ...
    <form @submit.prevent="login" class="flex flex-col border border-slate-300 rounded-xl shadow p-8 w-fit content-around justify-center gap-4">
